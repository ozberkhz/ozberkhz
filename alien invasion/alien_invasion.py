...
class AlienInvasion:
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # Remove any bullet-alien pair hat collides
        collisions = pygame.sprite.groupcollide(self.bullets, self.aliens, True, True) # The True parameters tell Pygame to remove both the bullet and the alien
    ...
    def _start_game(self):
        # Reset the game stats (make ship life count 3 again)
